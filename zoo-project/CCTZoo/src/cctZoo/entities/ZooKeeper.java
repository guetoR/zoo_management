...
public class ZooKeeper implements ZooKeeperInterface {
	...
	public String toString() {
		...
		return Auxiliar.BREAK_LINE + Auxiliar.BREAK_LINE + "Name: " + this.name + Auxiliar.BREAK_LINE + "ID: " + this.id
				+ Auxiliar.BREAK_LINE + "Qualified: " + qualified + Auxiliar.BREAK_LINE + "Number of animals alocated: "
				+ getNumberOfAnimalsAlocated() + Auxiliar.BREAK_LINE + "Types of Animal: "
